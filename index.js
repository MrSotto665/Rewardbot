        ...
        if (!user) {
            ...
            if (startPayload && Number(startPayload) !== userId) {
                ...
                if (referrer) {
                    ...
                    bot.telegram.sendMessage(referrer.userId, `🎉 Someone joined via your link! You got +50 matches.`).catch(e => {});
                }
            }
            await user.save();
        }
...
// ৬. স্ট্যাটাস ও রেফারেল (HTML Mode - Fix for underscores)
